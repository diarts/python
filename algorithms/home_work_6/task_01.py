...
# 3) сохранение данных по омпаниям в множестве set
    # Вариант с хранением дополнительного множества с прибылью за каждый квартал:
    ...
    # Вариант без хранения дополнительного множества с прибылью за каждый кварта
        # Итог: размер класса set переменной all_company = 224 байт,
        # размер словаря с 4 ключами компаний и их средней прибылью за 4 квартала = 807 байт
...
# Вариант без хранения дополнительного множества с прибылью за каждый квартал
...
for i in ('Coca Cola', 'Mac Donalds', 'Teremock', 'Crysler'):
    ...
    profit = sum(quartes)/QUARTES
    comp = Company(name=i, profit = profit)
...
# а имено - 583 байта
# 3 вариант немного выгоднее 2 (при условии, что мы не сохраняем в дополнительное множество все прибыли по месяцам),
# если е сохраняем, то 3 вариант становится перегруженым и занимает в памяти в 2 раза больше памяти,
# чем даже вариант 2